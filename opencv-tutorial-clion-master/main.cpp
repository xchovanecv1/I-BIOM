...
int main( int argc, const char** argv )
{
    ...
    Mat original = imread("../../iris/001/1/001_1_1.bmp", IMREAD_GRAYSCALE);
    ...
    HoughCircles(blacked_pupil, circles, HOUGH_GRADIENT, 1,
                 blacked_pupil.rows,  // change this value to detect circles with different distances to each other
